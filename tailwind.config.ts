    ...
    extend: {
      ...
      colors: {
        ...
        emergency: {
          ...
          "red-bg": "hsl(var(--emergency-red-bg))",
        },
        warning: {
          amber: "hsl(var(--warning-amber))",
          "amber-foreground": "hsl(var(--warning-amber-foreground))",
          "amber-bg": "hsl(var(--warning-amber-bg))",
        },
        safe: {
          green: "hsl(var(--safe-green))",
          "green-foreground": "hsl(var(--safe-green-foreground))",
          "green-bg": "hsl(var(--safe-green-bg))",
        },
        apple: {
          gray: {
            1: "#1D1D1F",
